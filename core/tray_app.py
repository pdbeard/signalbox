...
from .config import load_config, get_config_value, _default_config_manager
...
class SignalboxTray:
    ...
    def setup_menu(self):
        ...
        def toggle_notifications(checked):
            _default_config_manager.save_global_config_value("alerts.notifications.enabled", checked)
        ...
        def toggle_notify_mode(checked):
            _default_config_manager.save_global_config_value("alerts.notifications.on_failure_only", not checked)
